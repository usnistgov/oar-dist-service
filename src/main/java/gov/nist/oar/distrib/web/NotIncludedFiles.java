...
/**
 * @author Deoyani Nandrekar-Heinis
 * This class is a java object representing, files and urls which has some issues 
 * so they should not get included in data bundle plan which is posted to download data.
 */
...
public class NotIncludedFiles {
	 ...
	 * @param fPath String filename with path
	 * @param dUrl String download URL for given file
	 * @param msg String message why file not included
	 */
