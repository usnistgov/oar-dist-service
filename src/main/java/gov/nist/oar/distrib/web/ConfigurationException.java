...
public class ConfigurationException extends Exception {
     ...
     * 
     * @param param
     *            the configuration parameter name whose value (or lack thereof)
     *            has resulted in an error.
     * @param reason
     *            an explanation of what is wrong with the parameter. This will
     *            be combined with the parameter name to created the exception
     *            message (returned via {@code getMessage()}.
     * @param cause
     *            An underlying exception that was thrown as a result of the
     *            parameter value.
     */
    ...
    /**
     * return the explanation of how parameter is incorrect. This will not
