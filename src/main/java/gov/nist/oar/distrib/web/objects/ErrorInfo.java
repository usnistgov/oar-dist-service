...
public class ErrorInfo {
     ...
     * 
     * @param url
     *            the encoded URL accessed by the client. The output of
     *            HttpServletRequest.getRequestURI() is the recommended value as
     *            this string will generally be encoded.
     * @param httpstatus
     *            the HTTP status code accompanying this error response
     * @param reason
     *            an explanatory error message. (Note: details are not
     *            recommended for status &gt; 500.)
     * @param httpmeth
     *            the HTTP method used by the client (e.g. "GET", "HEAD", etc.)
     */
