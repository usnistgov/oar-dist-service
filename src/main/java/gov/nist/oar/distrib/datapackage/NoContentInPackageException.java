...
/**
 * This exception is thrown if the bundle/package for requested files is empty.s
 * @author Deoyani Nandrekar-Heinis
 *
 */
public class NoContentInPackageException extends DistributionException {
    /**
     * Create an exception with an arbitrary message
     */
    public NoContentInPackageException(String msg) {
	super(msg);
    }
     ...
     */
    public NoContentInPackageException(String msg, Throwable cause) {
	super(msg, cause);
    }
     ...
     * created.
     */
    public NoContentInPackageException(Throwable cause) {
	...
	return "No files added in package: ";
    }
