...
/**
 * Service interface for accessing preservation bags (AIP files) and information
 * about them.
 * <p>
 ...
 * Multibag BagIt Profile. This interface provides a means for identifying and
 * accessing the bag files.
 * 
 * @author Deoyani Nandrekar-Heinis
 */
public interface PreservationBagService {
    ...
    /**
     * Returns the bag for given complete bag file name. The bag data is
     * provided as an open InputStream in the returned StreamHandle container.
     * The
     * 
     * @param bagfile
