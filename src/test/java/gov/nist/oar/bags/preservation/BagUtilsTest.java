...
public class BagUtilsTest {
	...
	ArrayList<String> need = new ArrayList<String>(
		Arrays.asList("6376FC675D0E1D77E0531A5706812BC21886", "1_2_3_15", "10_22", "13", "zip"));
	ArrayList<String> test = (ArrayList<String>) BagUtils
		.parseBagName("6376FC675D0E1D77E0531A5706812BC21886.1_2_3_15.mbag10_22-13.zip");
	...
	assertEquals(need, BagUtils.parseBagName("691DDF3315711C14E0532457068146BE1907.3.mbag10_223-2.tar.gz"));
	...
	assertTrue("Compare not negative", vc.compare("goober.mbag0_2-0.7z", "goober.mbag0_2-0.zip") < 0);
	...
	assertEquals("6376FC675D0E1D77E0531A5706812BC21886.02.mbag10_22-14.zip", BagUtils.findLatestHeadBag(names));
	...
	assertEquals("6376FC675D0E1D77E0531A5706812BC21886.mbag10_24-15.zip", BagUtils.findLatestHeadBag(names));
	...
	assertEquals("6376FC675D0E1D77E0531A5706812BC21886.4_2.mbag10_22-15.zip", BagUtils.findLatestHeadBag(names));
