...
public class HeadBagUtilsTest {
	...
	assertEquals("mds1491.mbag0_2-0", HeadBagUtils.lookupFile("0.2", zis, "data/trial3/trial3a.json"));
	zis.close();
	...
	assertEquals("mds1491.1_1_0.mbag0_4-1", HeadBagUtils.lookupFile("0.4", zis, "data/trial3/trial3a.json"));
	zis.close();
	...
	zis = getClass().getResourceAsStream("/mds1491.1_1_0.mbag0_4-1.zip");
	zis = ZipBagUtils.openFileLookup("0.4", zis, "mds1491.1_1_0.mbag0_4-1").stream;
	assertEquals("mds1491.1_1_0.mbag0_4-1", HeadBagUtils.lookupFile(zis, "data/trial3/trial3a.json"));
	zis.close();
