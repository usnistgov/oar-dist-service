...
public class DatasetAccessControllerTest {
	...
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip", HttpMethod.GET, req,
		String.class);
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goober/_aip", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	JSONAssert.assertEquals("{requestURL:\"/oar-dist-service/ds/goober/_aip\","
		+ "status:404,message:\"Resource ID not found\",method:GET}", resp.getBody(), true);
    }

    @Test
    public void testDescribeAIPsEvil() throws JSONException {
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/%3Cscript%3Egoober%3C%2Fscript%3E/_aip",
		HttpMethod.GET, req, String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	assertFalse(resp.getBody().contains("script>"));
	JSONAssert.assertEquals("{status:404,message:\"Resource ID not found\",method:GET}", resp.getBody(), false);
    }

    @Test
    public void testListAIPVersions() throws JSONException {
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goober/_aip/_v", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v/0", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v/1.1.0", HttpMethod.GET, req, String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v/0/_head", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v/1.1.0/_head", HttpMethod.GET, req, String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goober/_aip/_v/0", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	...
	resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_v/12.32", HttpMethod.GET, req, String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	JSONAssert.assertEquals(
		"{requestURL:\"/oar-dist-service/ds/mds1491/_aip/_v/12.32\","
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_aip/_head", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.OK, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goober/_aip/_head", HttpMethod.GET, req,
		String.class);
	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/trial1.json", HttpMethod.GET, req,
		String.class);
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goober/trial1.json", HttpMethod.GET, req,
		String.class);
	...
	req = new HttpEntity<String>(null, headers);
	resp = websvc.exchange(getBaseURL() + "/ds/mds1491/goober/trial1.json", HttpMethod.GET, req, String.class);

	assertEquals(HttpStatus.NOT_FOUND, resp.getStatusCode());
	assertTrue(resp.getHeaders().getFirst("Content-Type").startsWith("application/json"));
	JSONAssert.assertEquals(
		"{requestURL:\"/oar-dist-service/ds/mds1491/goober/trial1.json\","
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/goob er/trial1.json", HttpMethod.GET, req,
		String.class);

	assertEquals(HttpStatus.BAD_REQUEST, resp.getStatusCode());
	assertTrue(resp.getHeaders().getFirst("Content-Type").startsWith("application/json"));
	JSONAssert.assertEquals("{requestURL:\"/oar-dist-service/ds/goob%20er/trial1.json\","
		+ "status:400,message:\"Malformed input\",method:GET}", resp.getBody(), true);

	/*
	 * Apparently the client or server is normalizing this input URL before
	 * our controller gets it.
	 *
	 * req = new HttpEntity<String>(null, headers); resp =
	 * websvc.exchange(getBaseURL() +
	 * "/ds/mds1491/trial3/../trial3/trial3a.json", HttpMethod.GET, req,
	 * String.class);
	 * 
	 * assertEquals(HttpStatus.BAD_REQUEST, resp.getStatusCode());
	 * assertTrue(resp.getHeaders().getFirst("Content-Type").startsWith(
	 * "application/json")); JSONAssert.assertEquals(
	 * "{requestURL:\"/oar-dist-service/ds/mds1491/trial3/../trial3/trial3a.json\","
	 * + "status:400,message:\"Malformed input\",method:GET}",
	 * resp.getBody(), true);
	 */

	req = new HttpEntity<String>(null, headers);
	resp = websvc.exchange(getBaseURL() + "/ds/mds1491/.trial3a.json", HttpMethod.GET, req, String.class);
	...
	HttpEntity<String> req = new HttpEntity<String>(null, headers);
	ResponseEntity<String> resp = websvc.exchange(getBaseURL() + "/ds/mds1491/_v/0/trial1.json", HttpMethod.GET,
		req, String.class);
