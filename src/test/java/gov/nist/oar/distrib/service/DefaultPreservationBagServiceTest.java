...
public class DefaultPreservationBagServiceTest {
	...
	// setup a little repo
	String[] bases = { "mds013u4g.1_0_0.mbag0_4-", "mds013u4g.1_0_1.mbag0_4-", "mds013u4g.1_1.mbag0_4-",
	...
	for (String name : fnames)
	    assertTrue("Unexpected bag name returned: " + name, name.startsWith("mds088kd2."));
    }
