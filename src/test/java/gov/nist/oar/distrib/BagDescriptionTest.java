...
public class BagDescriptionTest {
	...
	d = new BagDescription("greeting.txt", data.length(), "text/plain", Checksum.sha256("abcdef12345"));
	...
	BagDescription d = new BagDescription("mds25gd1k.2_1_51.mbag1_0-34.7z", 45098391472L, "text/plain",
		Checksum.sha256("abcdef12345"));
	...
	BagDescription d = new BagDescription("greeting.txt", 45098L, "text/plain", Checksum.sha256("abcdef12345"));
	String json = new ObjectMapper().writeValueAsString(d);
	assertThat(json, containsString("\"name\":"));
	assertThat(json, containsString("\"contentLength\":"));
	assertThat(json, containsString("\"checksum\":{\"hash\":"));
